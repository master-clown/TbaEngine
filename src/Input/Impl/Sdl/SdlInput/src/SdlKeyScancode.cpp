...
keyboard::KeyScancode sdl_input::fromSdlKeyScancode(const SDL_Scancode scancode)
{
    ...
    case From::SDL_SCANCODE_CAPSLOCK: return To::CapsLock;
    case From::SDL_SCANCODE_F1: return To::F1;
    case From::SDL_SCANCODE_F2: return To::F2;
    case From::SDL_SCANCODE_F3: return To::F3;
    case From::SDL_SCANCODE_F4: return To::F4;
    case From::SDL_SCANCODE_F5: return To::F5;
    case From::SDL_SCANCODE_F6: return To::F6;
    case From::SDL_SCANCODE_F7: return To::F7;
    case From::SDL_SCANCODE_F8: return To::F8;
    case From::SDL_SCANCODE_F9: return To::F9;
    case From::SDL_SCANCODE_F10: return To::F10;
    case From::SDL_SCANCODE_F11: return To::F11;
    case From::SDL_SCANCODE_F12: return To::F12;
    case From::SDL_SCANCODE_PRINTSCREEN: return To::PrintScreen;
    case From::SDL_SCANCODE_INSERT: return To::Insert;
    case From::SDL_SCANCODE_DELETE: return To::Delete;
    case From::SDL_SCANCODE_HOME: return To::Home;
    case From::SDL_SCANCODE_PAGEUP: return To::PageUp;
    case From::SDL_SCANCODE_PAGEDOWN: return To::PageDown;
    case From::SDL_SCANCODE_END: return To::End;
    case From::SDL_SCANCODE_LEFT: return To::LeftArrow;
    case From::SDL_SCANCODE_RIGHT: return To::RightArrow;
    case From::SDL_SCANCODE_UP: return To::UpArrow;
    case From::SDL_SCANCODE_DOWN: return To::DownArrow;
    case From::SDL_SCANCODE_APPLICATION: return To::ContextCmd;
...
SDL_Scancode sdl_input::toSdlKeyScancode(const keyboard::KeyScancode scancode)
{
    ...
    case From::CapsLock: return SDL_SCANCODE_CAPSLOCK;
    case From::F1: return SDL_SCANCODE_F1;
    case From::F2: return SDL_SCANCODE_F2;
    case From::F3: return SDL_SCANCODE_F3;
    case From::F4: return SDL_SCANCODE_F4;
    case From::F5: return SDL_SCANCODE_F5;
    case From::F6: return SDL_SCANCODE_F6;
    case From::F7: return SDL_SCANCODE_F7;
    case From::F8: return SDL_SCANCODE_F8;
    case From::F9: return SDL_SCANCODE_F9;
    case From::F10: return SDL_SCANCODE_F10;
    case From::F11: return SDL_SCANCODE_F11;
    case From::F12: return SDL_SCANCODE_F12;
    case From::PrintScreen: return SDL_SCANCODE_PRINTSCREEN;
    case From::Insert: return SDL_SCANCODE_INSERT;
    case From::Delete: return SDL_SCANCODE_DELETE;
    case From::Home: return SDL_SCANCODE_HOME;
    case From::PageUp: return SDL_SCANCODE_PAGEUP;
    case From::PageDown: return SDL_SCANCODE_PAGEDOWN;
    case From::End: return SDL_SCANCODE_END;
    case From::LeftArrow: return SDL_SCANCODE_LEFT;
    case From::RightArrow: return SDL_SCANCODE_RIGHT;
    case From::UpArrow: return SDL_SCANCODE_UP;
    case From::DownArrow: return SDL_SCANCODE_DOWN;
    case From::ContextCmd: return SDL_SCANCODE_APPLICATION;
