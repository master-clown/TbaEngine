...
String keyboard::str(const keyboard::KeyScancode code)
{
    ...
    case En::CapsLock: return "KeyScancode::CapsLock";
    case En::F1: return "KeyScancode::F1";
    case En::F2: return "KeyScancode::F2";
    case En::F3: return "KeyScancode::F3";
    case En::F4: return "KeyScancode::F4";
    case En::F5: return "KeyScancode::F5";
    case En::F6: return "KeyScancode::F6";
    case En::F7: return "KeyScancode::F7";
    case En::F8: return "KeyScancode::F8";
    case En::F9: return "KeyScancode::F9";
    case En::F10: return "KeyScancode::F10";
    case En::F11: return "KeyScancode::F11";
    case En::F12: return "KeyScancode::F12";
    case En::PrintScreen: return "KeyScancode::PrintScreen";
    case En::Insert: return "KeyScancode::Insert";
    case En::Delete: return "KeyScancode::Delete";
    case En::Home: return "KeyScancode::Home";
    case En::PageUp: return "KeyScancode::PageUp";
    case En::PageDown: return "KeyScancode::PageDown";
    case En::End: return "KeyScancode::End";
    case En::LeftArrow: return "KeyScancode::LeftArrow";
    case En::RightArrow: return "KeyScancode::RightArrow";
    case En::UpArrow: return "KeyScancode::UpArrow";
    case En::DownArrow: return "KeyScancode::DownArrow";
    case En::ContextCmd: return "KeyScancode::ContextCmd";
